 ...
 * @LastEditTime: 2020-06-14 22:08:44
    ...
    <Form :model="formHyjs" :label-width="80">
      <Row type="flex" justify="center">
        ...
        <Col :xs="20" :sm="24" :md="8" :lg="8">
          <FormItem label="时间">
            <DatePicker style="max-width:240px" type="daterange" placeholder="请选择" v-model="formHyjs.dateSelect" @on-change="dataChange" :options="dateOptions" ></DatePicker>
          </FormItem>
          </Col>
